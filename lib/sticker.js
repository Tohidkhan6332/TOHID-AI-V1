...
async function addExif(webpSticker, packname, author, categories = [], extra = {}) {
	...
	const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'link-group-bot': 'https://chat.whatsapp.com/IqRWSp7pXx8DIMtSgDICGu', 'link-script-github': 'https://github.com/Tohidkhan6332/TOHID-AI-V1', ...extra };
